    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6 col-12">
        <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                <a href="#" class="btn btn-sm btn-primary" id="addButton" data-bs-toggle="modal">Departman ekle</a>
            </div>
        </div>
    </div>
                        ...
                        <tbody class="fw-semibold text-gray-600">
							 @foreach ($departments as $department)
								<tr>
                                    ...
                                    <td class="text-center px-md-12 px-6 py-6">
                                         <span class="badge badge-light-primary">{{$department->employees_count}}</span>
                                    </td>
								    <td class="text-end px-md-12 px-6 py-4">
								        <div class="text-end">
								           <div class="d-flex align-items-center justify-content-end">
								            <a onclick="modal({{$department->id}})" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1 bg-gray-200i">
								            ...
								            <a onclick="deleteDepartment('{{route('departmanlar.delete',$department->id)}}')" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm bg-gray-200i">
...
<div class="modal fade draggable" id="kt_modal_create_department" tabindex="-1" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-dialog-centered mw-500px">
        <div class="modal-content">
            <form method="post" id="kt_modal_create_department" class="form w-100 needs-validation" action="{{route('departmanlar.store')}}">
                @csrf
                <div class="modal-header ui-draggable-handle py-5" id="kt_modal_add_customer_header">
                    <h3 class="fw-bolder">Departman Ekle</h3>
                ...
                <div class="modal-body py-5 px-12">
                    <div class="scroll-y " id="kt_modal_add_customer_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_customer_header" data-kt-scroll-wrappers="#kt_modal_add_customer_scroll" data-kt-scroll-offset="300px">
                         <div class="fv-row mb-5">
                             <label class="form-label fs-7">Departman Adı</label>
                         ...
                         <div class="fv-row mb-5">
                             <label class="form-label fs-7">Şube</label>
                             <select name="branch_id" id="branch-select" class="form-select form-control-lg mb-2 @error('branch_id') border-danger @enderror" data-control="select2" data-dropdown-parent="#kt_modal_create_department" data-placeholder="Şube Seçiniz">
                                      ...
                                      <tr>
                                          ...
                                          <td class="d-flex justify-content-end">
                                              <label class="form-check form-check-sm form-check-custom form-check-solid me-9">
                                                  <input class="form-check-input" @checked(old('monday')) name="monday" type="checkbox" value="1">
                                              </label>
                                          </td>
                                      </tr>
                                      <tr>
                                          ...
                                          <td class="d-flex justify-content-end">
                                              <label class="form-check form-check-sm form-check-custom form-check-solid me-9">
                                                  <input class="form-check-input" @checked(old('tuesday')) name="tuesday" type="checkbox" value="1">
                                              </label>
                                          </td>
                                      </tr>
                                      <tr>
                                          ...
                                          <td class="d-flex justify-content-end">
                                              <label class="form-check form-check-sm form-check-custom form-check-solid me-9">
                                                  <input class="form-check-input" @checked(old('wednesday')) name="wednesday" type="checkbox" value="1">
                                              </label>
                                          </td>
                                      </tr>
                                      <tr>
                                          ...
                                          <td class="d-flex justify-content-end">
                                              <label class="form-check form-check-sm form-check-custom form-check-solid me-9">
                                                  <input class="form-check-input" @checked(old('thursday')) name="thursday" type="checkbox" value="1">
                                              </label>
                                          </td>
                                      </tr>
                                      <tr>
                                          ...
                                          <td class="d-flex justify-content-end">
                                              <label class="form-check form-check-sm form-check-custom form-check-solid me-9">
                                                  <input class="form-check-input" @checked(old('friday')) name="friday" type="checkbox" value="1">
                                              </label>
                                          </td>
                                      </tr>
                                      <tr>
                                          ...
                                          <td class="d-flex justify-content-end">
                                              <label class="form-check form-check-sm form-check-custom form-check-solid me-9">
                                                  <input class="form-check-input" @checked(old('saturday')) name="saturday" type="checkbox" value="1">
                                              </label>
                                          </td>
                                      </tr>
                                      <tr>
                                          ...
                                          <td class="d-flex justify-content-end">
                                              <label class="form-check form-check-sm form-check-custom form-check-solid me-9">
                                                  <input class="form-check-input" @checked(old('sunday')) name="sunday" type="checkbox" value="1">
                                              </label>
                                          </td>
                                      </tr>
                                  </tbody>
                ...
                <div class="modal-footer flex-center py-2">
                    ...
                    <button type="submit" class="btn btn-primary min-w-200px"><i class="las la-check-double fs-2"></i>Departman Ekle </button>
                </div>
            </form>
        </div>
    </div>
</div>
<div class="modal fade draggable" id="kt_modal_edit_department" tabindex="-1" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-dialog-centered mw-500px py-2">
        <div class="modal-content">
            <form method="post" id="kt_modal_edit_department_form" class="form w-100">
                @method('PUT')
                @csrf
                <div class="modal-header py-5">
                    <h3 class="fw-bolder">Departman Düzenle</h3>
                    <div class="btn btn-icon btn-sm btn-active-light-primary ms-2" data-bs-dismiss="modal" aria-label="Close">
                        <span class="svg-icon svg-icon-2x">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                <g transform="translate(12.000000, 12.000000) rotate(-45.000000) translate(-12.000000, -12.000000) translate(4.000000, 4.000000)" fill="#000000">
                ...
                <div class="modal-body py-5 px-lg-17">
                    <div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_customer_header" data-kt-scroll-wrappers="#kt_modal_add_customer_scroll" data-kt-scroll-offset="300px">
                        ...
                        <div class="fv-row mb-5">
                            <label class="form-label fs-7">Şube</label>
                            <select name="update_branch_id" id="branch-select2" class="form-select form-control-lg mb-2 @error('update_branch_id') border-danger @enderror" data-control="select2" data-dropdown-parent="#kt_modal_edit_department" data-placeholder="Şube Seçiniz">
                                <option value="none" selected disabled hidden>-Seçiniz-</option>
                                @foreach ($branchs as $branch)
                                <option @selected(old('update_branch_id')==$branch->id) value="{{$branch->id}}">{{$branch->name}}</option>
                                @endforeach
                            </select>
                           ...
                           <table class="table align-middle table-row-dashed fs-6 gy-5">
                               <tbody class="text-gray-600 fw-semibold">
                                <tr>
                                    ...
                                    <td class="d-flex justify-content-end">
                                        <label class="form-check form-check-sm form-check-custom form-check-solid me-9">
                                            <input class="form-check-input" @checked(old('monday')) name="monday" id="monday" type="checkbox" value="1">
                                        </label>
                                    </td>
                                </tr>
                                   <tr>
                                       ...
                                       <td class="d-flex justify-content-end">
                                           <label class="form-check form-check-sm form-check-custom form-check-solid me-9">
                                               <input class="form-check-input"  @checked(old('tuesday')) name="tuesday" id="tuesday" type="checkbox" value="1">
                                           </label>
                                       </td>
                                   </tr>
                                   <tr>
                                       ...
                                       <td class="d-flex justify-content-end">
                                           <label class="form-check form-check-sm form-check-custom form-check-solid me-9">
                                               <input class="form-check-input" @checked(old('wednesday')) name="wednesday" id="wednesday" type="checkbox" value="1">
                                           </label>
                                       </td>
                                   </tr>
                                   <tr>
                                       ...
                                       <td class="d-flex justify-content-end">
                                           <label class="form-check form-check-sm form-check-custom form-check-solid me-9">
                                               <input class="form-check-input" @checked(old('thursday')) name="thursday" id="thursday" type="checkbox" value="1">
                                           </label>
                                       </td>
                                   </tr>
                                   <tr>
                                       ...
                                       <td class="d-flex justify-content-end">
                                           <label class="form-check form-check-sm form-check-custom form-check-solid me-9">
                                               <input class="form-check-input" @checked(old('friday')) name="friday" id="friday" type="checkbox" value="1">
                                           </label>
                                       </td>
                                   </tr>
                                   <tr>
                                       ...
                                       <td class="d-flex justify-content-end">
                                           <label class="form-check form-check-sm form-check-custom form-check-solid me-9">
                                               <input class="form-check-input"  @checked(old('saturday')) name="saturday" id="saturday" type="checkbox" value="1">
                                           </label>
                                       </td>
                                   </tr>
                                <tr>
                                    ...
                                    <td class="d-flex justify-content-end">
                                        <label class="form-check form-check-sm form-check-custom form-check-solid me-9">
                                            <input class="form-check-input"  @checked(old('sunday')) name="sunday" id="sunday" type="checkbox" value="1">
                                        </label>
                                     </td>
                                </tr>
                               </tbody>
...
<script>
    function modal(id)
    {
        ...
        var Ajaxurl = '{{ route('departmanlar.show', ':id') }}';
        Ajaxurl = Ajaxurl.replace(':id', id);
        var url = '{{ route('departmanlar.update', ':id') }}';
        url = url.replace(':id', id);
         $.ajax({
            ...
            success: function (response) {
                ...
                if (optionValue == response.department.branch_id) {
                $(this).prop('selected', true);
                branchSelect.trigger('change');
                }
                });
                if(response.department.monday)
                {
                     $('#monday').prop('checked',true);
                }else{
                     $('#monday').prop('checked',false);
                }
                if(response.department.tuesday)
                {
                     $('#tuesday').prop('checked',true);
                }else{
                    $('#tuesday').prop('checked',false);
                }
                if(response.department.wednesday)
                {
                     $('#wednesday').prop('checked',true);
                }else{
                     $('#wednesday').prop('checked',false);
                }
                if(response.department.thursday)
                {
                     $('#thursday').prop('checked',true);
                }else{
                     $('#thursday').prop('checked',false);
                }
                if(response.department.friday)
                {
                     $('#friday').prop('checked',true);
                }else{
                     $('#friday').prop('checked',false);
                }
                if(response.department.saturday)
                {
                ...
                $('#kt_modal_edit_department_form').attr('action',url);
...
<script>
   $(document).ready(() => {
     setTimeout(() => {
         $('#kt_modal_create_department').modal('show');
     }, 500);
   });
</script>
@endif
    ...
    $.ajax({
      ...
      success: function (response) {
        if (response.limitReached) {
          ...
          $('#kt_modal_create_department').modal('show'); // Show the modal if limit is not reached
        }
      },
      error: function () {
