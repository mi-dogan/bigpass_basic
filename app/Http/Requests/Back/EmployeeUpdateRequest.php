...
//            'email' => 'required|email|max:255|unique:employees,email,'.$this->id.',id',
//            'email' => ['required', 'email', 'max:255', Rule::unique('employees', 'email')->ignore($this->id)],
            ...
            'urgent_phone' => 'nullable|string|regex:/05[0,3,4,5,6][0-9]\d\d\d\d\d\d\d$/',
            'degree' => 'nullable|max:255',
            'registration_number' => 'nullable|string|max:20',
            'father_name' => 'nullable|string|max:255',
            'mother_name' => 'nullable|string|max:255',
            'birthdate' => 'nullable|date',
            'volume_number' => 'nullable|string|max:12',
            'serial_number' => 'nullable|string|max:6',
            'family_serial_number' => 'nullable|string|max:12',
            'identification_number' => 'nullable|string|regex:/^[1-9]{1}[0-9]{9}[02468]{1}$/',
            'retired_registration_number' => 'nullable|string|max:12',
